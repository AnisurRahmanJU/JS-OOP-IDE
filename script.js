...
let fileSystem = {
    "Shape.js": {
        "type": "file",
        "content": `// Parent Class: Shape\nclass Shape {\n    constructor(name, color, width = null) {\n        this.name = name;\n        this.color = color;\n        if (width) console.log("Shape received private data from child:", width);\n    }\n\n    describe() {\n        return \`This is a \${this.color} \${this.name}.\`;\n    }\n}`
    },
    "Rectangle.js": {
        "type": "file",
        "content": `// Child Class: Rectangle extending Shape\nclass Rectangle extends Shape {\n    #width;\n    #height;\n\n    constructor(color, width, height) {\n        // Pass the private data to the parent during initialization\n        super("Rectangle", color, width);\n        this.#width = width;\n        this.#height = height;\n        \n        // Print verification\n        console.log("Internal private data initialized:", this.#width, this.#height);\n    }\n\n    get width() {\n        return this.#width;\n    }\n\n    getPrivateData() {\n        return {\n            w: this.#width,\n            h: this.#height\n        };\n    }\n\n    getArea() {\n        return this.#width * this.#height;\n    }\n\n    displayDetails() {\n        console.log(\`Shape Analysis Mode:\`);\n        return this.describe() + \` It has an area of \` + this.getArea() + \` square units.\`;\n    }\n}`
    },
    "Main.js": {
        "type": "file",
